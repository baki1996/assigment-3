            ...
            <div className="p-4 w-[100%] md:w-1/3">
             ...
             <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                ...
                <div className="flex-grow">
                    <div className="relative h-1 w-full bg-gray-300 rounded-xl ">
                        <div className="absolute bg-purple-500 h-1 rounded-xl w-[40%]"></div>
                    </div>
                    <p className="font-bold text-purple-500 text-right">40%</p>
                </div>
              </div>
            </div>
             {/* skill */}
             <div className="p-4 w-[100%]  md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                ...
                <div className="flex-grow">
                    <div className="relative h-1 w-full bg-gray-300 rounded-xl ">
                        <div className="absolute bg-purple-500 h-1 rounded-xl w-[50%]"></div>
                    </div>
                    <p className="font-bold text-purple-500 text-right">50%</p>
                </div>
              </div>
            </div>
          </div>
